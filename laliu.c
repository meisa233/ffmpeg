...
// input ....................
    ...
    set_block_timeout_time(get_systime() + 10*1000000);
...
// output ..............................
    ...
    while(1){
        set_block_timeout_time(get_systime() + 8000000);
        ...
        if(in_packet->stream_index == videoindex){
            ...
            printf("recv %5d video frame %5d-%5d", ++video_frame_count, in_packet->size, video_frame_size);
        }

        
        if(in_packet->stream_index == audioindex){
            audio_frame_size += in_packet->size;
            printf("recv %5d audio frame %5d-%5d", ++audio_frame_count, in_packet->size, audio_frame_size);
        }
